...
public class MealTestData {
    ...
    public static final MatcherFactory<MealTo> MATCHER_MEAL_TO = MatcherFactory.usingIgnoringFieldsComparator(MealTo.class, "user");
    ...
    public static final List<MealTo> mealTos = MealsUtil.getTos(List.of(meal7, meal6, meal5, meal4, meal3, meal2, meal1), MealsUtil.DEFAULT_CALORIES_PER_DAY);
